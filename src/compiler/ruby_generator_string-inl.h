...
inline std::string RubyPackage(const grpc::protobuf_inworld::FileDescriptor* file) {
...
inline std::string RubyTypeOf(const grpc::protobuf_inworld::Descriptor* descriptor) {
