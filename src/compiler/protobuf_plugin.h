...
class ProtoBufMethod : public grpc_generator::Method {
 public:
  ProtoBufMethod(const grpc::protobuf_inworld::MethodDescriptor* method)
      : method_(method) {}
 ...
 private:
  const grpc::protobuf_inworld::MethodDescriptor* method_;
};

class ProtoBufService : public grpc_generator::Service {
 public:
  ProtoBufService(const grpc::protobuf_inworld::ServiceDescriptor* service)
      : service_(service) {}
 ...
 private:
  const grpc::protobuf_inworld::ServiceDescriptor* service_;
};
...
class ProtoBufPrinter : public grpc_generator::Printer {
 ...
 private:
  grpc::protobuf_inworld::io::StringOutputStream output_stream_;
  grpc::protobuf_inworld::io::Printer printer_;
};

class ProtoBufFile : public grpc_generator::File {
 public:
  ProtoBufFile(const grpc::protobuf_inworld::FileDescriptor* file) : file_(file) {}
 ...
 private:
  const grpc::protobuf_inworld::FileDescriptor* file_;
};
