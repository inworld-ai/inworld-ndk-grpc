...
class ProtoServerReflectionTest : public ::testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    ref_desc_pool_ = protobuf_inworld::DescriptorPool::generated_pool();
  ...
  void CompareService(const std::string& service) {
    const protobuf_inworld::ServiceDescriptor* service_desc =
        desc_pool_->FindServiceByName(service);
    const protobuf_inworld::ServiceDescriptor* ref_service_desc =
    ...
    const protobuf_inworld::FileDescriptor* file_desc = service_desc->file();
  ...
  void CompareMethod(const std::string& method) {
    ...
    const protobuf_inworld::MethodDescriptor* ref_method_desc =
  ...
  void CompareType(const std::string& type) {
    ...
    const protobuf_inworld::Descriptor* desc = desc_pool_->FindMessageTypeByName(type);
    const protobuf_inworld::Descriptor* ref_desc =
 ...
 protected:
  ...
  const protobuf_inworld::DescriptorPool* ref_desc_pool_;
  int port_;
