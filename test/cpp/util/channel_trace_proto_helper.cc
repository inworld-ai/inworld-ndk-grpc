...
void VaidateProtoJsonTranslation(const std::string& json_str) {
  Message msg;
  grpc::protobuf_inworld::json::JsonParseOptions parse_options;
  ...
  grpc::protobuf_inworld::util::Status s =
      grpc::protobuf_inworld::json::JsonStringToMessage(json_str, &msg, parse_options);
  EXPECT_TRUE(s.ok());
  std::string proto_json_str;
  grpc::protobuf_inworld::json::JsonPrintOptions print_options;
  ...
  s = grpc::protobuf_inworld::json::MessageToJsonString(msg, &proto_json_str);
  EXPECT_TRUE(s.ok());
